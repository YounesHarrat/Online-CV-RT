    ...
    <>
        ...
        <main className='grid w-screen h-fit place-items-center bg-slate-200 gap-10 py-10'>
          <section className='w-4/5 h-fit rounded-3xl shadow-[-10px_-10px_30px_4px_rgba(255,255,255,.1),_10px_10px_30px_4px_rgba(0,0,0,.15)]'>
            <div className='text-5xl text-center p-4 text-white bg-sky-500 border-black border-b-2'>Younes Harrat</div>
            ...
            <div className="xps-template flex flex-col justify-evenly gap-1 px-12 pb-12">
              ...
              <div className="opinion shadow-[-10px_-10px_30px_4px_rgba(255,255,255,0.1),_10px_10px_30px_4px_rgba(0,0,0,0.15)] rounded-3xl p-4">
                <p className="p-8">
                  ...
                  I liked the overall atmosphere of the company and their kindness and their open-minded spirit ! <br/>
                  I like being tasked some back-end works and learned how to handle it better than i did. <br/>
                  And how could i forget the usual friday team-building time at the restaurant ! <br/>
            ...
            <div className="xps-template flex flex-col justify-evenly gap-1 px-12 pb-12">
              ...
              <div className="opinion shadow-[-10px_-10px_30px_4px_rgba(255,255,255,0.1),_10px_10px_30px_4px_rgba(0,0,0,0.15)] rounded-3xl p-4">
                <p className="p-8">
                  ...
                  KISS (Keep it Stupid and Simple) and also the infamous but necessary RTM (Read The Manual) 
                  {/** What did i like ? how was it ? what did i learn ? */}
                </p>
              </div>
